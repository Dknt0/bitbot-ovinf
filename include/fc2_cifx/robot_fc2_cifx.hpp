...
void RobotFc2Cifx::GetDevice(const KernelBus& bus) {
  // TODO:
  motors_[LHipYawMotor] = bus.GetDevice<MotorDevice>(10).value();
  motors_[LHipRollMotor] = bus.GetDevice<MotorDevice>(11).value();
  motors_[LHipPitchMotor] = bus.GetDevice<MotorDevice>(12).value();
  ...
  motors_[RHipYawMotor] = bus.GetDevice<MotorDevice>(3).value();
  motors_[RHipRollMotor] = bus.GetDevice<MotorDevice>(4).value();
  motors_[RHipPitchMotor] = bus.GetDevice<MotorDevice>(5).value();
  motors_[RKneeMotor] = bus.GetDevice<MotorDevice>(6).value();
  motors_[RAnklePitchMotor] = bus.GetDevice<MotorDevice>(7).value();
  motors_[RAnkleRollMotor] = bus.GetDevice<MotorDevice>(8).value();

  motors_[LShoulderPitchMotor] = bus.GetDevice<MotorDevice>(1).value();
  motors_[LShoulderRollMotor] = bus.GetDevice<MotorDevice>(1).value();
  motors_[LShoulderYawMotor] = bus.GetDevice<MotorDevice>(1).value();
  motors_[LElbowPitchMotor] = bus.GetDevice<MotorDevice>(1).value();

  motors_[RShoulderPitchMotor] = bus.GetDevice<MotorDevice>(0).value();
  motors_[RShoulderRollMotor] = bus.GetDevice<MotorDevice>(0).value();
  motors_[RShoulderYawMotor] = bus.GetDevice<MotorDevice>(0).value();
  motors_[RElbowPitchMotor] = bus.GetDevice<MotorDevice>(0).value();
